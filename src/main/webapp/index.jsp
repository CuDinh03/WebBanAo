            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <div class="ps-5 d-non d-lg-block">
                    <div class="nav-item dropdown">
                        <a href="#" id="menu" type="button" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
