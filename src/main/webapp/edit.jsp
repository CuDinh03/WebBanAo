...
<div>
  ...
  <input class="form-control" value=" ${pr.productId}"  type="text" name="id1">
  <p class="text-dark text-md-left">Mã thực phẩm</p>
  <input class="form-control" type="text" value=" ${pr.productCode}" name="prCode">
  <p class="text-dark text-md-left">Tên sản phẩm</p>
  <input class="form-control" type="text" value=" ${pr.productName}" name="prName">
  <p class="text-dark text-md-left">Giá thực phẩm</p>
  <input class="form-control "  type="text" name="prPrice" value="${pr.productPrice}">
  <p class="text-dark text-md-left">Số lượng sản phẩm</p>
  <input class="form-control" type="text"value=" ${pr.productQuantity}"  name="prQuantity">
  ...
  <input class="form-control" type="text"value=" ${pr.productInputDay}"  name="prDateInput">
  <p class="text-dark text-md-left">Hạn sử dụng</p>
  <input class="form-control" type="text" value=" ${pr.productExpiry}" name="prDateEx">
