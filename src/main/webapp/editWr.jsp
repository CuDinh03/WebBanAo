...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/BroadServlet">
            ...
            <div class="sidebar-brand-text mx-3">Chào quản lý: Minh Mon</div>
        </a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div>
            <form action="/EditWrServlet" method="post" accept-charset="UTF-8">

                <p class="text-dark text-md-left">ID</p>
                <input class="form-control" value="${w.wareHouseId}" type="text" name="idWr" readonly>
                <p class="text-dark text-md-left">Mã kho hàng </p>
                <input class="form-control" value="${w.wareHouseCode}" type="text" name="codeWr" readonly >
                <p class="text-dark text-md-left">Tên kho hàng</p>
                <input class="form-control" type="text" value="${w.wareHouseName}" name="nameWr">
                <p class="text-dark text-md-left">Địa chỉ kho hàng</p>
                <input class="form-control" type="text" value="${w.wareHouseLocation}" name="locationWr">
                <button class="btn btn-secondary" type="button">Huỷ</button>
                <button class="btn btn-primary" type="submit" id="editBtn" formmethod="post">Save
                </button>
            </form>
        ...
        $("#editBtn").click(function(event) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    window.location.href = '/ShowWarehouseServlet'; // redirect to new page using a serverlet after success message is shown
