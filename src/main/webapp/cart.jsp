...
<%@ page import="com.example.quanlykho.model.Cart" %>
<%@ page import="com.example.quanlykho.dao.CRUD_Products" %>
<%@ page import="com.example.quanlykho.dao.Connect_sql" %><%--
...
<%
    ...
    if (cart_list != null) {
        CRUD_Products pDao = new CRUD_Products(Connect_sql.getConnect());
                            ...
                            <div class="col-lg-6 px-5 py-4">
                                ...
                                <div class="d-flex align-items-center mb-5">
                                    <div class="flex-shrink-0">
                                        <img src="<%= c.getProductImg()%>"
                                             class="img-fluid" style="width: 150px;" alt="Generic placeholder image">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <a href="#!" class="float-end text-black"><i class="fas fa-times"></i></a>
                                        <h5 class="text-primary"><%= c.getProductName()%></h5>
                                        <div class="d-flex align-items-center">
                                            <p class="fw-bold mb-0 me-5 pe-3"><%= dcf.format(c.getProductPrice())%></p>
                            ...
                            <div class="col-lg-6 px-5 py-4">
                                ...
                                <form class="mb-5">
                                    ...
                                    <h5 class="fw-bold mb-5" style="position: absolute; bottom: 0;">
                                        <a href="/BroadServlet"><i class="fas fa-angle-left me-2"></i>Back to shopping</a>
                                    </h5>
